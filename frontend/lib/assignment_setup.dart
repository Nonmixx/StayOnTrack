...
/// Collects group member info, assignment details, and brief
class AssignmentSetupPage extends StatefulWidget {
  const AssignmentSetupPage({Key? key}) : super(key: key);

  @override
  State<AssignmentSetupPage> createState() => _AssignmentSetupPageState();
}

class _AssignmentSetupPageState extends State<AssignmentSetupPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('New Group Assignment'),
